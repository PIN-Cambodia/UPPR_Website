...
<div class="px-plugin-wrapper">
	...
	<div class="px-plugin-sidebar">
		...
		<div class="block-section">
			<img src="<?php echo esc_url( LSCF_PLUGIN_URL . 'assets/images/pixolette-logo.png' ); ?>"/>
		</div>
		...
		<div class="block-section">
			...
			<a class="underline" href="https://wp.pixolette.com/docs/general/faq/">FAQ</a><br/>
			<a class="underline" href="https://wp.pixolette.com/contact/">Need a customization?</a><br/>
		</div>
		<br />
		...
		<div class="block-section">
			<h2>More Products</h2>
			<a class="underline" href="https://wp.pixolette.com/wordpress-plugins" target="_blank">WordPress Plugins</a><br/>
			<a class="underline" href="https://wp.pixolette.com/wordpress-themes" target="_blank">WordPress Plugins</a>
		</div>
						...
						<form id="generateshortcode-form">
							...
							<div class="lscf-step-2">
								...
								<div class="step5 step-shape last-step">
									...
									<hr class="silver"/>
									<label>Generate shortcode. Copy and pase the generated shortcode into desired page for filter to show up.<br/>

										<span class="lscf-lite-notice"><b>You are using LSCF LITE.</b> <span style="color:red;">You can have max 3 fields per filter page. Unlock <b>LSCF PRO</b> to get unlimited fields on your filter page</span></span>
